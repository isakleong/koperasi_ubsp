				...
				<table width="650" border="0" cellspacing="0" cellpadding="0" class="mobile-shell">
					<tr>
						<td class="td" style="width:650px; min-width:650px; font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal;">
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<th class="column-top" width="200"style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal; vertical-align:top;">
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															<td class="text-top m-center mpb5"style="color:#FFFFFF; font-family:'Times New Roman', Georgia, serif; font-size:12px; line-height:22px; text-align:left; text-transform:uppercase;"><multiline>Sistem Akuntansi UBSP</multiline></td>
														</tr>
													</table>
												</th>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ebebeb">
								<tr>
									<td class="p30-15-0" style="padding: 50px 30px 0px;" bgcolor="#ffffff">
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td class="h5-center"style="color:#a1a1a1; font-family:'Raleway', Arial,sans-serif; font-size:24px; line-height:22px; text-align:center; padding-bottom:22px;">Halo,</td>
											</tr>
											<tr>
												<td class="h2-center"style="color:#000000; font-family:'Raleway', Arial,sans-serif; font-size:32px; line-height:36px; text-align:center; padding-bottom:5px;">Terima kasih sudah mendaftar di Sistem Akuntansi UBSP!</td>
											</tr>
										</table>
									</td>
								</tr>
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#dde8fd">
											...
											<tr>
												<td class="p0-15" style="padding: 0px 30px;">
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															<td class="h2-center"style="color:#000000; font-family:'Raleway', Arial,sans-serif; font-size:32px; line-height:36px; text-align:center; padding-bottom:20px;"><multiline>Selamat bergabung jadi anggota Sistem Akuntansi UBSP!</multiline></td>
														</tr>
														<tr>
															<td class="text-center"style="color:#000000; font-family:'Raleway', Arial,sans-serif; font-size:16px; line-height:22px; text-align:center; padding-bottom:22px;">Silahkan klik tombol Verifikasi dibawah ini agar Anda dapat segera mengakses semua fitur dari Sistem Akuntansi UBSP</td>
														</tr>
														<tr>
															<td class="text-center"style="color:#000000; font-family:'Kreon', Georgia, serif; font-size:14px; line-height:22px; text-align:center; padding-bottom:22px; font-style: italic;">Note: Jika Anda merasa tidak mendaftar, Anda dapat mengabaikan email ini.</td>
														</tr>
														<tr>
															<td align="center">
																<table border="0" cellspacing="0" cellpadding="0">
																	<tr>
																		<td class="text-button button-blue2"style="font-family:'Raleway', Arial,sans-serif; font-size:14px; line-height:18px; text-align:center; padding:10px 30px; border-radius:20px; background:#1e52bd; color:#ffffff; font-weight:bold;"><multiline><a href="{{$url}}" target="_blank" class="link-white"style="color:#ffffff; text-decoration:none;"><span class="link-white"style="color:#ffffff; text-decoration:none; font-weight:bold;">VERIFIKASI</span></a></multiline></td>
																	</tr>
																</table>
															</td>
														</tr>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ebebeb">
								<tr>
									<td class="p30-15-0" style="padding: 5px 30px 0px;" bgcolor="#ffffff">
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td class="h5-center"style="color:#000000; font-family:'Raleway', Arial,sans-serif; font-size:16px; line-height:22px; text-align:center; padding-bottom:22px;">Jika tombol di atas tidak berfungsi, silahkan salin dan gunakan link berikut di browser Anda: {{$url}}</td>
											</tr>
										</table>
									</td>
								</tr>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td class="text-footer2 p30-15" style="padding: 30px 15px 50px 15px; color:#ffffff; font-family:'Raleway', Arial,sans-serif; font-size:12px; line-height:22px; text-align:center;"><multiline>Jika Anda membutuhkan bantuan, <br />Silahkan hubungi nomor ini <a href="https://api.whatsapp.com/send?phone=6285162673572" target="_blank" class="link-white"style="font-family:'Raleway', Arial,sans-serif; color:#ffffff; text-decoration:none;"><span class="link-white"style="color:#ffffff; text-decoration:none;">+6285162673572</span></a></multiline></td>sdsd
								</tr>
							</table>
							<!-- END Footer -->
						</td>
