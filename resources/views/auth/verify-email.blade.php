  ...
  <body>
    ...
    <div class="container-xxl container-p-y">
      <div class="misc-wrapper">
        ...
        <p class="mb-4 mx-2">Link verifikasi telah berhasil dikirim ke email Anggota. Mohon untuk follow up anggota terkait agar bisa segera melakukan verifikasi akun Sistem Akuntansi UBSP.</p>
        <a href="{{ route('admin.dashboard') }}" class="btn btn-primary">Back to home</a>
        <div class="mt-3">
          <img
            src="/administrator/assets/img/illustrations/page-misc-error-light.png"
