                        ...
                        @if (isset($configuration) && count($configuration) == 2)
                            <form action="{{ route('admin.user.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="mothername" name="mothername"
                                            placeholder="" required value="{{ old('mothername') }}" />
                                ...
                                <div class="alert alert-primary" role="alert">
                                    <div class="mt-3">
                                        <h6 class="text-primary mb-0">Default Password</h6>
                                        <input type="text" readonly class="form-control-plaintext"
                                            id="defaultPassword" name="password"
                                            value="{{ $configuration[0]->value }}" />
                                    </div>
                                    <div class="mt-3">
                                        <h6 class="text-primary mb-0">Simpanan Pokok</h6>
                        ...
                        @else
                            <div class="container-xxl container-p-y text-center">
                                <div class="misc-wrapper">
                                    ...
                                    <h5 class="mb-4 mx-2">Konfigurasi anggota UBSP tidak ditemukan, silahkan melakukan
                                        setting terlebih dahulu.</h5>
                                </div>
                            </div>
                        @endif
