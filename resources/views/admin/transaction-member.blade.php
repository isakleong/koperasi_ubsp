                    ...
                    <div class="card-body">
                        <div class="row justify-content-between mb-3">
                            ...
                            <span class="col-md-12 col-lg-5 col-xl-12 col-xxl-5 text-center mx-auto mx-md-0 mb-2"><img
                                    src="/assets/images/simpanan.svg" class="w-85 m-2"
                                    style="mix-blend-mode: multiply;filter: contrast(1);"></span>
                        </div>
                        <button type="button" class="btn btn-primary text-white w-100 fw-medium shadow-sm"
                            data-bs-toggle="modal" data-bs-target="#simpanan">Transaksi Simpanan</button>
                    </div>
                </div>
            </div>
                ...
                <div class="card mb-4 bg-gradient">
                    <div class="card-body">
                        <div class="row justify-content-between mb-3">
                            ...
                            <span class="col-md-12 col-lg-5 col-xl-12 col-xxl-5 text-center mx-auto mx-md-0 mb-2"><img
                                    src="/assets/images/pinjaman.svg" class="w-85 m-2"
                                    style="mix-blend-mode: multiply;filter: contrast(1);"></span>
                        </div>

                        <a href="{{ route('admin.transaction.member') }}"
                            class="btn btn-primary text-white w-100 fw-medium shadow-sm">Transaksi Pinjaman</a>
                    </div>
                </div>
            </div>
                ...
                <div class="card mb-4 bg-gradient">
                    <div class="card-body">
                        <div class="row justify-content-between mb-3">
                            ...
                            <span class="col-md-12 col-lg-5 col-xl-12 col-xxl-5 text-center mx-auto mx-md-0 mb-2"><img
                                    src="/assets/images/angsuran.svg" class="w-85 m-2"
                                    style="mix-blend-mode: multiply;filter: contrast(1);"></span>
                        </div>

                        <a href="{{ route('admin.transaction.member') }}"
                            class="btn btn-primary text-white w-100 fw-medium shadow-sm">Transaksi Angsuran</a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-12 mb-3">
                            <div class="form-check custom-option custom-option-basic">
                                <label class="form-check-label custom-option-content ps-3" for="customRadioTemp1">
                                    <a href="{{ route('admin.transaction.member.saving.deposit') }}"
