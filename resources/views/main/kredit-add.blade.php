                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                @if ($cntActiveLoan > 0)
                                    ...
                                    <h6 class="text-center mt-3">Mohon maaf, Anda belum dapat mengajukan kredit karena masih
                                        ada kredit yang belum disetujui atau kredit yang belum lunas.</h6>
                                @else
                                    <form action="{{ route('store.kredit') }}" class="form form-vertical"
                                        id="formSimulasiKredit" method="post">
                                        {{ csrf_field() }}
                                        <div class="form-body">
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="form-group has-icon-left">
                                                        ...
                                                        <div class="position-relative">
                                                            <input type="text" class="form-control" placeholder="Bunga"
                                                                id="rates" value="0.5" name="rates" readonly />
                                                ...
                                                <div class="col-12 d-flex justify-content-center">
                                                    <button id="hitungSimulasi" type="button"
                                                        class="btn btn-primary mb-3 mt-3 simulasi" data-bs-toggle="modal"
                                                        data-bs-target="#hasilSimulasi">Hitung Simulasi</button>
                                                </div>

                                                <div class="modal fade" id="hasilSimulasi" data-bs-keyboard="false"
                                                    tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="staticBackdropLabel">Simulasi
                                                                    Kredit</h5>
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="divider">
                                                                    <div class="divider-text"
                                                                        style="font-weight: bold; color:#000000;">Rincian
                                                                        Angsuran (Per Bulan)</div>
                                                                </div>
                                                                ...
                                                                <h6 class="labelResultSimulasi">Total Angsuran Yang Dibayar
                                                                </h6>
